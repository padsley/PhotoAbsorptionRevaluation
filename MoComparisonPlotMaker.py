...
nucleiData = np.loadtxt("Mo96.csv",delimiter=',')
...
nucleiData2 = np.loadtxt("Mo96_IAEA_database.csv",delimiter=',')



mask = np.abs(nucleiData2[:,0]<24e6)#truncate to <24 MeV for the gamma-ray energy
